    ...
    <body>
        <div>
            ...
            <form action="register" method="get">
                ...
                <input  name="email" type="email"  title=" (format: xxx@xxx.xxx)" 
                 pattern="[a-zA-Z0-9!#$%&amp;'*+\/=?^_`{|}~.-]+@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*">
                <p>Enter your password</p>
                <input type="password" name="pass" pattern=".{6,}" title="Six or more characters" placeholder="Six or more characters">
                <p>Enter your mobile number</p>
               <input type="tel" name="mob" pattern="[0-9]{11}" required><br>
